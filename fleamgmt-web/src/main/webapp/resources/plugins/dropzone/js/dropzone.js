					...
					function(b, c, d) {
						(function() {
							...
							j = (function(o) {
								var p;
								h(n, o);
								n.prototype.events = [ "drop", "dragstart", "dragend", "dragenter", "dragover",
								...
								n.prototype.defaultOptions = {
									...
									addedfile : function(q) {
										...
										q.previewElement.querySelector("[data-dz-size]").innerHTML = this
												.filesize(q.size);
									...
									uploadprogress : function(s, q, r) {
										return s.previewElement.querySelector("[data-dz-uploadprogress]").style.width = ""
												+ q + "%"
									},
								...
								function n(s, r) {
									...
									if (this.options.previewsContainer) {
										this.previewsContainer = n.getElement(this.options.previewsContainer,
												"previewsContainer")
									} else {
									...
									this.clickableElements.forEach(function(y) {
										return x.listeners.push({
											...
											events : {
												click : function(z) {
													if ((y !== x.element)
															|| (z.target === x.element || n.elementInside(z.target,
																	x.element.querySelector(".dz-message")))) {
								...
								n.prototype.accept = function(r, q) {
									if (r.size > this.options.maxFilesize * 1024 * 1024) {
										return q(this.options.dictFileTooBig.replace("{{filesize}}",
												Math.round(r.size / 1024 / 10.24) / 100).replace("{{maxFilesize}}",
										...
										if (!n.isValidFile(r, this.options.acceptedFiles)) {
											...
											if (this.options.maxFiles
													&& this.getAcceptedFiles().length >= this.options.maxFiles) {
												q(this.options.dictMaxFilesExceeded.replace("{{maxFiles}}",
								...
								n.prototype.addFile = function(q) {
									...
									if (this.options.createImageThumbnails && q.type.match(/image.*/)
								...
								n.prototype.createThumbnail = function(r) {
									...
									q.onload = function() {
										...
										t.onload = function() {
											...
											v.drawImage(t, (x = z.srcX) != null ? x : 0, (u = z.srcY) != null ? u : 0,
													z.srcWidth, z.srcHeight, (A = z.trgX) != null ? A : 0,
													(y = z.trgY) != null ? y : 0, z.trgWidth, z.trgHeight);
								...
								n.prototype.uploadFiles = function(z) {
									...
									E = function() {
										...
										for (V = 0, U = z.length; V < U; V++) {
											N = z[V];
											T.push(L._errorProcessing(z, r
													|| L.options.dictResponseError.replace("{{statusCode}}", C.status),
													C))
										}
										return T
									};
									...
									if (this.element.tagName === "FORM") {
										...
										for (s = 0, Q = x.length; s < Q; s++) {
											...
											if (!J || ((u = J.toLowerCase()) !== "checkbox" && u !== "radio")
													|| H.checked) {
												M.append(D, H.value)
											}
										}
									...
									for (q = 0, O = z.length; q < O; q++) {
										N = z[q];
										M.append("" + this.options.paramName
												+ (this.options.uploadMultiple ? "[]" : ""), N, N.name)
									}
									return C.send(M)
								};
